...
**2026-09-19 amendment (v0.21.0):** the managed server's start line lists the built-in features in effect; see [Startup visibility of effective features](#startup-visibility-of-effective-features).
